...
static const char *screenshotcmd[] = { "wl-script", "screenshot", NULL };
static const char *volumedowncmd[] = { "wl-script", "volume_down", NULL };
static const char *volumeupcmd[] = { "wl-script", "volume_up", NULL };
static const char *lightupcmd[] = { "wl-script", "light_up", NULL };
static const char *lightdowncmd[] = { "wl-script", "light_down", NULL };
...
static const Key keys[] = {
	...
	{ 0,                      XKB_KEY_XF86MonBrightnessDown,spawn,        {.v = lightdowncmd} },
	{ 0,                      XKB_KEY_XF86MonBrightnessUp,spawn,          {.v = lightupcmd} },
